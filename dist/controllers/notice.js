...
const renew_js_ticket_app = (access_token) => __awaiter(void 0, void 0, void 0, function* () {
    let res = yield get_js_ticket_app(access_token);
    if (res.errcode == 0 && res.errmsg == 'ok') {
        let fileData = {
            ticket: res.ticket,
            expries_time: new Date().getTime() + 7200 * 1000
...
const handle_js_ticket_app = (access_token) => __awaiter(void 0, void 0, void 0, function* () {
...
class Notice {
    ...
    index(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let ticket_app = yield handle_js_ticket_app(token);
